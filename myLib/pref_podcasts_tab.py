...
class PrefPodcastsTab(Preferences):
    ...
    def check_for_new_content_setting(self, setting):
        ...
        self.select_menu_value(option, setting, menu_width=550, yoffset="120")

    def autodownload_setting(self, setting):
        option = self._AUTODOWNLOAD
        self.select_menu_value(option=option, setting=setting, menu_width=550, yoffset=200)
        
    def default_view_setting(self, setting):
        option = self._DEFAULT_VIEW
        self.select_menu_value(option, setting, menu_width=550, yoffset="180")
